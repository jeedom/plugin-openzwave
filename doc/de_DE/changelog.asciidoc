...
** Rückgabe des json Pfad /ZWaveAPI/Run/devices[<int:node_id>].GetPendingChanges() plus hinzugefügtem Resultat.
** Rückgabe des json Pfad /ZWaveAPI/Run/devices[<int:node_id>].GetLastNotification() plus hinzugefügtem Resultat.
