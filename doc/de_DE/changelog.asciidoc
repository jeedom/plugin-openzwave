...
Detailliertes Änderungsprotokoll : https://github.com/jeedom/plugin-openzwave/commits/stable

== 2017-08-xx

* Neue Eigenschaften

** Möglichkeit, die Steuerelemente eines Geräts zu aktualisieren, ohne die vorhandenen zu entfernen.
** Möglichkeit, einen Informationsbefehl für die Werte der Registerkarte System zu erstellen.

* Verbesserungen/Erweiterungen

** Unterstützung für neue Module, OZW Definitionen und Befehle.
** Die Möglichkeit, der standard Assoziation (ohne Instanz) für die Module auszuwählen, die die multi-Instanzen Assoziationen unterstützen.
** Überprüfung der Gültigkeit der Assoziations-Gruppen am Ende des Interviews.
** Wiederherstellung des letzten Batteriestands beim starten des Daemons.

* Fehlerbehebungen

** Die Migration der Batterie-Informationen wurde korrigiert.
** Die Rückmeldung der Batterieinfo im Gerätebildschirm wurde behoben
** Wiederherstellen des Batterien-Typs in der Modul Konfiguration.
