...
** Restoration du type de piles dans les configurations de modules.
...
** Supression de la notification du changement de valeur avant quelle est été appliqué.
** Ne plus afficher le cadenas dans l'écran du module si le module ne supporte pas la Classe de Commande Securité.
