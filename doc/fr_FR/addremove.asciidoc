...
Si toutefois un module ne peut être inclu en mode sécurisé, veuillez l'inclure en mode *Non sécurisé*.
...
Cette action va récupérer l'ensemble des dernières versions des fichiers de configuration openzwave ainsi que le mapping de commandes Jeedom.
