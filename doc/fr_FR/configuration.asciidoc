...
** *Activer les tests sanitaires* : aux 15 minutes de l'heure le plugin va effectuer une série de tests sur l'ensemble des équipements actifs de votre réseau.
...
Permet d'afficher ou non le panel mobile lors que vous utilisez l'application sur un téléphone.
