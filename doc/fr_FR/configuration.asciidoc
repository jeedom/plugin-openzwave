...
** *Mettre à jour la configuration des modules automatiquement, chaque jour à minuit* : option pour activer la mise à jour des configuration de module openzwave ainsi de les fichier de commande Z-Wave.
