...
* *Dernière notification* : Date de dernière notification reçu du module ainsi que l'heure du prochain réveil prévue, pour les modules qui dorment.
** Elle permet en plus d'informer si le noeud ne s'est pas encore réveillé une fois depuis le lancement du démon.
** Et indique si un noeud ne s'est pas réveillé comme prévue.
* *Ping* : Permet d'envoyer une série de messages au module pour tester son bon fonctionnement.


Les équipments désactivé seront affiché mais aucunes informations de diagnostique ne sera présente.
