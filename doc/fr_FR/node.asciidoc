...
Si aucun fichier de configuration est définie pour le module, un assistant manuel vous pemet d'appliquer des paramètres au module.
image:../images/node17.png[]
Veillez vous référer à la documentation du fabricant pour connaitre la définition de l'index, valeur et taile.
