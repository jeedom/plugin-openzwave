...
include_file('3rdparty', 'vivagraph/vivagraph.min', 'js', 'openzwave');
?>
			...
			<div id="network-tab-content" class="tab-content">
				<div class="tab-pane active" id="summary_network">
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							...
							<p>Intervalle des demandes : <span class="network-poll-interval label label-default">inconnu</span> secondes</p>
				...
				<div class="tab-pane" id="statistics_network">
					...
					<table class="table table-condensed table-striped">
						<tr>
							<td><b>Nobre d'émissions lues :</b></td><td> <span class="stats_broadcastReadCnt"></span></td>
						</tr><tr>
