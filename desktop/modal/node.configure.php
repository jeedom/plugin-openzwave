            ...
            <div id="content">
                ...
                <div id="my-tab-content" class="tab-content">
                    ...
                    <div class="tab-pane" id="groups">
                        <button type="button" id="addGroup" class="btn btn-primary addGroup"><i class="fa fa-plus"></i>
                    ...
                    <div class="tab-pane" id="actions">
                        <table class="table table-striped">
                            ...
                            <tr>
                                <td>
                                    <button type="button" id="refreshNodeInfo" class="btn btn-success refreshNodeInfo">
                    ...
                    <div class="tab-pane" id="statistics">
                        ...
                        <table class="table table-striped table-condensed">
                            ...
                            <tr>
                                ...
                                <td><span class="stats_sen_cnt"></span></td>
                            </tr>
                            <tr>
                                <td><b>{{Nombre de messages envoyés en erreur :}}</b></td>
                                <td><span class="stats_sen_failed"></span></td>
                            </tr>
                            <tr>
                                <td><b>{{Heure du dernier message envoyé :}}</b></td>
                                <td><span class="stats_sen_ts"></span></td>
                            </tr>
                        </table>
                    </div>
                </div>
