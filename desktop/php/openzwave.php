    ...
    <form class="form-horizontal">
        <fieldset>
            <legend><i class="fa fa-info-circle"></i> {{Informations}}
                ...
                <i id="bt_autoDetectModule" class="fa fa-search expertModeVisible pull-right cursor" title="{{Appliquer le mapping de commandes}}"></i>
                <i id="bt_displayZwaveData" title="{{Voir l'arbre Z-Wave}}" class="fa fa-tree expertModeVisible pull-right cursor"></i>
            </legend>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <a class="btn btn-primary" id="bt_configureDevice" title='{{Configurer}}'>
                    <i class="fa fa-wrench"></i> {{Configuration}}
                </a>
                <a class="btn btn-info" id="bt_deviceAssistant" title='{{Assistant de configuration spécifique}}' style="display:none;">
                    <i class="fa fa-magic"></i> {{Assistant}}
                </a>
                <a class="btn btn-default" id="bt_deviceDocumentation" title='{{Documentation du module}}' target="_blank" style="display:none;">
                    <i class="fa fa-book"></i> {{Documentation}}
                </a>
                <a class="btn btn-warning" id="bt_deviceRecommended" title="{{Appliquer le jeu de configuration recommandée par l'équipe Jeedom}}" style="display:none;">
                    <i class="fa fa-thumbs-up"></i> {{Configuration recommandée}}
                </a>
            </div>
        </div>
        <center>
...
<div role="tabpanel" class="tab-pane" id="commandtab">
    <a class="btn btn-success btn-sm cmdAction expertModeVisible pull-right" data-action="add"> <i class="fa fa-plus-circle"></i> {{Commandes}}</a>
    <br/><br/>
