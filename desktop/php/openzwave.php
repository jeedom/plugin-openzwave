...
<div class="row row-overflow">
    ...
    <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay"
        ...
        <div class="eqLogicThumbnailContainer">
            ...
            <div class="cursor expertModeVisible" id="bt_syncEqLogic"
                 style="background-color : #ffffff; height : 140px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;">
                <center>
                    <i class="fa fa-refresh" style="font-size : 6em;color:#767676;"></i>
                </center>
                <span
                    style="font-size : 1.1em;position:relative; top : 23px;word-break: break-all;white-space: pre-wrap;word-wrap: break-word;color:#767676"><center>{{Synchroniser}}</center></span>
            </div>

            <div class="cursor expertModeVisible" id="bt_zwaveNetwork"
                 style="background-color : #ffffff; height : 140px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;">
                <center>
            ...
            <div class="cursor expertModeVisible" id="bt_zwaveHealth"
                ...
                <span
                    style="font-size : 1.1em;position:relative; top : 23px;word-break: break-all;white-space: pre-wrap;word-wrap: break-word;color:#767676"><center>{{Santé}}</center></span>
            </div>
        </div>
    ...
    <div class="col-lg-10 col-md-9 col-sm-8 eqLogic"
                ...
                <form class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="checkbox" class="eqLogicAttr bootstrapSwitch" data-label-text="{{Activer}}"
                                       data-l1key="isEnable" checked/>
                                <input type="checkbox" class="eqLogicAttr bootstrapSwitch" data-label-text="{{Visible}}"
                        ...
                        <div class="form-group expertModeVisible">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control eqLogicAttr" data-l1key="configuration"
                                        data-l2key="serverID">
                                    <?php
                                    foreach (openzwave::listServerZwave() as $id => $server) {
                                        if (isset($server['name'])) {
      ...
      <span class="tooltips label label-default" style='font-size : 1em;'>
        ...
        <span class="eqLogicAttr tooltips" data-l1key="configuration" data-l2key="conf_version"
              title="{{Version de la configuration}}"></span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <a class="btn btn-primary" id="bt_configureDevice" title='{{Configurer}}'><i
                                        class="fa fa-wrench"></i> {{Configuration}}</a>
                                <a class="btn btn-info" id="bt_deviceAssistant"
                                   title='{{Assistant de configuration spécifique}}' style="display:none;"><i
                                        class="fa fa-magic"></i> {{Assistant}}</a>
                                <a class="btn btn-default" id="bt_deviceDocumentation"
        ...
        <a class="btn btn-success btn-sm cmdAction expertModeVisible" data-action="add"><i
