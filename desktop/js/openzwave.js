...
function addCmdToTable(_cmd) {
    ...
    tr += '</td>';
    tr += '<td class="expertModeVisible"><input class="cmdAttr form-control input-sm" data-l1key="configuration" data-l2key="instance" value="1"></td>';
    ...
    tr += '<td class="expertModeVisible">';
    if (init(_cmd.type) == 'action' || init(_cmd.type) == null){
