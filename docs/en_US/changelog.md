...
- Rajout de nombreuses confs (pour rappel le bouton récupérer les confs est utile pour être up to date sans mettre up to date le plugin)
...
-   Nouveautés
    ...
    -   Retour de la possibilité de synchroniser les confs sans mettre up to date le plugin
...
-   Improvements/Enhancements
    ...
    -   Désactivation (temporaire) du moteur de mise up to date des
    ...
    -   Optimisations du code de la bibliothèque openzwave.
        ...
        -   La commande bouton relâcher (Stop d'un volet) ne force plus
            la mise up to date de l'ensemble des valeurs du module
...
-   Improvements/Enhancements
    ...
    -   Détection du RPI3 dans la mise up to date des dépendances.
...
-   Improvements/Enhancements
    ...
    -   Mise up to date de la librairie OpenZWave 1.4.2088.
...
-   New Features
    ...
    -   Ajout de la demande de mise up to date des routes de retour
        au contrôleur.
...
-   Improvements/Enhancements
    ...
    -   Mise up to date de la librairie OpenZWave 1.4.296.
    ...
    -   Documentation update du plugin.

-   Bug Fixes

    -   Correction de possible problèmes lors de la mise up to date des
        configurations de modules.
...
-   Improvements/Enhancements
    ...
    -   Mise up to date du wrapper python OpenZWave en version 0.3.0.

    -   Mise up to date de la librairie OpenZWave 1.4.248.
...
-   New Features
    ...
    -   Ajout d'option pour activer/désactiver la mise up to date des
    ...
    -   Ajout d'une option pour désactiver la mise up to date automatique
...
-   Improvements/Enhancements
    ...
    -   Mise up to date du wrapper python OpenZWave en version 0.3.0b9.

    -   Mise en évidence des groupes d'associations qui sont en attente
        d'être appliqués.

    -   Mise up to date de la librairie OpenZWave 1.4.167.
...
-   New Features
    ...
    -   Mise up to date de la configuration de module automatique toutes
        les nuits.
...
-   Improvements/Enhancements
    ...
    -   Mise up to date de la librairie OpenZWave en 1.4
