...
- Rajout de nombreuses confs (pour rappel le bouton récupérer les confs est utile pour être al día sans mettre al día le plugin)
...
-   Nouveautés
    ...
    -   Retour de la possibilité de synchroniser les confs sans mettre al día le plugin
...
-   Improvements/Enhancements
    ...
    -   Désactivation (temporaire) du moteur de mise al día des
    ...
    -   Optimisations du code de la bibliothèque openzwave.
        ...
        -   La commande bouton relâcher (Stop d'un volet) ne force plus
            la mise al día de l'ensemble des valeurs du module
...
-   Improvements/Enhancements
    ...
    -   Détection du RPI3 dans la mise al día des dépendances.
...
-   Improvements/Enhancements
    ...
    -   Mise al día de la librairie OpenZWave 1.4.2088.
...
-   New Features
    ...
    -   Ajout de la demande de mise al día des routes de retour
        au contrôleur.
...
-   Improvements/Enhancements
    ...
    -   Mise al día de la librairie OpenZWave 1.4.296.
    ...
    -   Actualización de la documentación du plugin.

-   Bug Fixes

    -   Correction de possible problèmes lors de la mise al día des
        configurations de modules.
...
-   Improvements/Enhancements
    ...
    -   Mise al día du wrapper python OpenZWave en version 0.3.0.

    -   Mise al día de la librairie OpenZWave 1.4.248.
...
-   New Features
    ...
    -   Ajout d'option pour activer/désactiver la mise al día des
...
-   New Features
    ...
    -   Mise al día de la configuration de module automatique toutes
        les nuits.
...
-   Improvements/Enhancements
    ...
    -   Mise al día de la librairie OpenZWave en 1.4
